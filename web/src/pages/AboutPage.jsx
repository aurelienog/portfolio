...
function AboutPage() {
  return (
      ...
      <section className="mx-auto">
        <h1 className='text-5xl md:text-9xl'>Mi viaje hacia la programación</h1>
        ...
        <article className='space-y-8'>
          ...
          <p>Hoy, estoy en búsqueda de mi primera oportunidad profesional como desarrolladora Full Stack, donde pueda aplicar lo aprendido y seguir creciendo en un <b className='highlight'>entorno colaborativo</b>.</p>
