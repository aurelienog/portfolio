...
function Footer() {
  return (
    <footer style={{ WebkitMaskImage: `url(${footerMask})`, maskImage: `url(${footerMask})` }} className={`bg-[url(../../footerImg.png)] bg-bottom bg-cover h-[20rem] flex flex-col justify-end p-8 [-webkit-mask-size:auto] md:[-webkit-mask-size:100%_100%] [-webkit-mask-repeat:no-repeat] [-webkit-mask-position:center]`}>
