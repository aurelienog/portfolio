  ...
  return (
    <form onSubmit={handleSubmit(onMessageSubmit)} className='my-12'>
      <div className='mb-8'>
        ...
        <div className='mt-8'>
          <button type='submit' className={`w-full cursor-pointer bg-[#e10505]/90 uppercase outline-2 font-bold text-white rounded-2xl px-8 py-4 ${!isValid || isSubmitting ? 'opacity-70 pointer-events-none' : ''} shadow-2xl`}>{isSubmitting ? 'Enviando...' : 'Enviar mensaje'}</button>
        </div>
