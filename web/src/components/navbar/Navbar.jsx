...
function Navbar() {
  ...
  return (
      <nav id="main-navigation" className='md:w-[80%] mx-auto max-w-screen-xl md:mx-auto px-10 md:px-0 relative font-sans text-2xl flex items-center justify-between'>
