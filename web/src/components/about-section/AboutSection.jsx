...
function AboutSection() {
  return (
    <section className='bg-black rounded-4xl text-white/90 lg:grid grid-cols-[auto_1fr] items-center'>
      ...
      <article className='py-8 space-y-4'>
        <h2 className='mt-8 text-white/90'>Mi salto al desarrollo</h2>
          ...
          <p> Busco una oportunidad laboral en Bilbao de forma presencial, o en remoto si el proyecto lo permite.</p>
