    ...
    <section className='bg-black rounded-4xl text-white/90 p-8 md:grid grid-cols-[auto_1fr] items-center'>
      ...
      <article className='space-y-4'>
        <h2 className='mt-8 text-4xl md:text-6xl text-white/90'>Mi salto al desarrollo</h2>
          ...
          <Link to="/about" className='shadow-[0_0_5px_theme(colors.purple.200),_0_0_20px_theme(colors.purple.700)] inline-block mt-12 rounded-full px-8 py-4 mb-8 font-bold bg-black text-white/90 text-center cursor-pointer hover:scale-110 transition-transform'>Más sobre mí</Link>
      </article> 
    </section>
  )
}
