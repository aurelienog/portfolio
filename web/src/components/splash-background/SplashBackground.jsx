...
function SplashBackground({image}) {
  return (
      <div className='h-full relative'>
        ...
        <img src={image} alt="Retrato de Aurelie sobre un fondo de manchas de acuarela" className={`saturate-125 h-[90%] object-cover [-webkit-mask-image:linear-gradient(rgb(0_0_0_/1),rgb(0_0_0_/0.99),rgb(0_0_0_/0))] [mask-image:linear-gradient(rgb(0_0_0_/1),rgb(0_0_0_/0.99),rgb(0_0_0_/0))]`} />
      </div>
  )
}
